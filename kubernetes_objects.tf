...
module "storage_class" {
  source = "github.com/YpNo/terraform-kubernetes-objects//modules/kubernetes-objects/storageclass?ref=v1.0.0"
...
module "priority_class" {
  source = "github.com/YpNo/terraform-kubernetes-objects//modules/kubernetes-objects/priorityclass_v1?ref=v1.0.0"
...
module "cluster_roles" {
  source = "github.com/YpNo/terraform-kubernetes-objects//modules/kubernetes-objects/clusterrole_v1?ref=v1.0.0"
...
module "cluster_role_bindings" {
  source = "github.com/YpNo/terraform-kubernetes-objects//modules/kubernetes-objects/clusterrolebinding_v1?ref=v1.0.0"
